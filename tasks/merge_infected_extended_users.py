...
def process_dict_data(start_index, end_index, current_time, net_sim_dict):
        ...
        for index in range(start_index,end_index):
            ...
            try:
                ...
                for x in source_candidates:
                    ...
                    if net_sim_dict[x]['time_lapsed'] <= current_time:
                        sources.append(x)
            ...
            if len(sources) > 0:
                ...
                first_source_row = net_sim_dict[first_source_index]
                first_source_seed_row = net_sim_dict[first_source_row['seed_index']]
                source_rows = list(map(lambda x: net_sim_dict[x], sources))
                ...
                degreeList = list(net_sim_dict[i]['followers_count'] + net_sim_dict[i]['friends_count']  for i in sources)
                timeList = [current_time - net_sim_dict[x]["time_lapsed"] for x in sources]


                last_source_index = sources[-1]
                last_source_row = net_sim_dict[last_source_index]
                last_source_seed_row = net_sim_dict[last_source_row['seed_index']]
                ...
                if user_row['time_lapsed'] <= current_time:
                    ...
                    net_sim_dict[usr_index]['time_lapsed'] = user_row['time_lapsed']

                    net_sim_dict[usr_index]['source_index'] = user_row['source_index']
                    net_sim_dict[usr_index]['seed_index'] = user_row['seed_index']
                    net_sim_dict[usr_index]['generation'] = user_row['generation']
                    net_sim_dict[usr_index]['time_since_seed'] = user_row['time_since_seed']

                net_sim_dict[usr_index]['source_candidates'] = sources
                ...
                features['Stat_average_deltaDays'].append(mean_of(source_rows, "user_created_days"))
                features['Stat_average_statusesCount'].append(mean_of(source_rows, "statuses_count"))
                features['Stat_average_followersCount'].append(mean_of(source_rows, "followers_count"))
                features['Stat_average_favouritesCount'].append(mean_of(source_rows, "favourites_count"))
                features['Stat_average_friendsCount'].append(mean_of(source_rows, "friends_count"))
                features['Stat_average_listedCount'].append(mean_of(source_rows, "listed_count"))
                features['Stat_average_normalizedUserStatusesCount'].append(mean_of(source_rows, "normalized_statuses_count"))
                features['Stat_average_normalizedUserFollowersCount'].append(mean_of(source_rows, "normalized_followers_count"))
                features['Stat_average_normalizedUserFavouritesCount'].append(mean_of(source_rows, "normalized_favourites_count"))
                features['Stat_average_normalizedUserListedCount'].append(mean_of(source_rows, "normalized_listed_count"))
                features['Stat_average_normalizedUserFriendsCount'].append(mean_of(source_rows, "normalized_friends_count"))
